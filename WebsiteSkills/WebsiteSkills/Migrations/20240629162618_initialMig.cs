    ...
    public partial class initialMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ListaMentoresId = table.Column<int>(type: "int", nullable: false),
                    ListaSkillsSkillsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentorSkills", x => new { x.ListaMentoresId, x.ListaSkillsSkillsId });
                    table.ForeignKey(
                        name: "FK_MentorSkills_Skills_ListaSkillsSkillsId",
                        column: x => x.ListaSkillsSkillsId,
                        principalTable: "Skills",
                        principalColumn: "SkillsId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MentorSkills_Utilizadores_ListaMentoresId",
                        column: x => x.ListaMentoresId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dataSubscricao = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscricoes", x => new { x.SkillsFK, x.AlunoFK });
                    table.ForeignKey(
                        name: "FK_Subscricoes_Skills_SkillsFK",
                        column: x => x.SkillsFK,
                        principalTable: "Skills",
                        principalColumn: "SkillsId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subscricoes_Utilizadores_AlunoFK",
                        column: x => x.AlunoFK,
                        principalTable: "Utilizadores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MentorSkills_ListaSkillsSkillsId",
                table: "MentorSkills",
                column: "ListaSkillsSkillsId");
